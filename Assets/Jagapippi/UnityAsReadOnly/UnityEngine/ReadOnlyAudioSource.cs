...
{
    public interface IReadOnlyAudioSource : IReadOnlyBehaviour
    {
    ...
    public sealed class ReadOnlyAudioSource : ReadOnlyBehaviour<AudioSource>, IReadOnlyAudioSource
    {
        ...
        public IReadOnlyAudioClip clip => (_obj.clip == null) ? null : _obj.clip.AsReadOnly();
    ...
    {
        public static IReadOnlyAudioSource AsReadOnly(this AudioSource self) => new ReadOnlyAudioSource(self);
    }
}